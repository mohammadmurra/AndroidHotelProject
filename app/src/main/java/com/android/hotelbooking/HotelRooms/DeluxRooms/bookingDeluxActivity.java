...
public class bookingDeluxActivity extends AppCompatActivity {
    TextView roomName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_booking_delux_room);
        buttonReserve = findViewById(R.id.buttonReserveDelux);
        Intent i = getIntent();
        ...
        buttonReserve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showPopupWindowDelux popUpClass = new showPopupWindowDelux();
    ...
    public void ReserveRoomDelux(View view) {

        String URL = "http://"+getResources().getString(R.string.databaseIp)+"/login/reserveRoomDelux.php?roomName="+room+"&user="+user+"";
